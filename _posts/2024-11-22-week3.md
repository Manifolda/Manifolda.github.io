---
title: 傅里叶变换与特征函数
description: 傅里叶变换是复分析的重要内容，傅里叶变换的数学性质为概率论中的特征函数方法提供了基础
author: manifolda
date: 2024-11-22
categories: [数学, 统拔]
...
mermaid: true
image:
  path: /assets/baidubaike.webp
  
---

## 引言
傅里叶变换在概率论中有重要的应用，特别是与特征函数相关联，下面简要介绍复数基本知识和傅里叶变换的基本性质以方便同学们在概率论中应用，部分定理超出所学知识，定理将不加证明给出，感兴趣的同学可以尝试证明
...
> 定义（复积分）
> 
> $当\gamma分段可微时, 其方程为z=z(t)(a\leq t\leq b), f(z)在\gamma上定义且连续$
> $则f(z(t))也是t的连续函数$
